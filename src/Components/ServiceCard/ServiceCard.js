...
const ServiceCard = (props) => {
    ...
    return (
            ...
            <div onClick={handleCardClick} style={{cursor: 'pointer'}} className="col-lg-4 col-md-12 col-sm-12 service-card">
              <div class="card h-100 mb-3 g-0 border-0" style={{borderRadius: '10px', height: '250px'}}>
              <div class="row h-100 g-0" style={{height: '250px'}}>
                <div class="md-6 " style={{borderRadius: '20px'}}>
